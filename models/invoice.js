...
const Invoice = {
  ...
  insertOne: (vals, cb) => {
    const queryString = 'INSERT INTO invoices (res_room_id, num_days, rate, county_tax, city_tax, state_tax, payment_type) VALUES (?,?,?,?,?,?,?);'
