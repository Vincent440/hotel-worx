                            ...
                            <Row>
                                <Col xl={10}>
                                    <Row id="firstRow">
                                        ...
                                        <Col xs={1} sm={1} md={1} lg={1} xl={1}>Clean</Col>
                                        <Col xs={1} sm={1} md={1} lg={1} xl={1}>
                                            <input type="checkbox" id="clean" checked={this.state.checked.clean}
                                                onChange={this.handleCheckboxChange} />
                                        </Col>
                                        <Col xs={2} sm={2} md={2} lg={2} xl={2}>Dirty {this.state.rooms}</Col>
                                        <Col xs={1} sm={1} md={1} lg={1} xl={1}>
                                    ...
                                    <Row id="secondRowP">
                                        ...
                                        <Col xs={1} sm={1} md={1} lg={1} xl={1}>Vacant</Col>
                                        <Col xs={1} sm={1} md={1} lg={1} xl={1}>
                                            <input type="checkbox" id="vacant" checked={this.state.checked.vacant}
                                                onChange={this.handleCheckboxChange} />

                                        </Col>
                                        <Col xs={2} sm={2} md={2} lg={2} xl={2}>Occupied</Col>
                                        <Col xs={1} sm={1} md={1} lg={1} xl={1}>
                                    ...
                                    <Row id="secondRow" >
                                        ...
                                        <Col xs={2} sm={2} md={2} lg={1} xl={1}>Arrived</Col>
                                        <Col xs={1} sm={1} md={1} lg={1} xl={1}>
                                            <input type="checkbox" id="arrived" checked={this.state.checked.arrived}
                                                onChange={this.handleCheckboxChange} />
                                        </Col>

                                        <Col xs={2} sm={2} md={2} lg={2} xl={2}>Stay Over</Col>
                                        <Col xs={1} sm={1} md={1} lg={1} xl={1}>
