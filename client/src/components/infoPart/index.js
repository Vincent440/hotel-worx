    ...
    render() {
        return (
            <Card id="infoCard">
                ...
                <button className="btn btn-block btn-default" style={{width:"50px",paddingLeft:"7px", paddingTop:"15px", marginTop:"30px", marginLeft:"70px"}}><i class="fa fa-gear" style={{fontSize:"28px", color:"white" }}></i></button>
